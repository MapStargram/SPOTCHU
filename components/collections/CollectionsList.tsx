  ...
  return (
    <div className="flex min-h-dvh w-full justify-center bg-[color:var(--cream-2)]">
      <div className="relative flex min-h-dvh w-full max-w-[430px] flex-col bg-cream px-4 pb-28 pt-14">
        ...
        {/* Segmented */}
        <div className="mt-4 flex rounded-full bg-[color:var(--cream-2)] p-1 font-ko text-[12px] font-bold">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          {list.map((col) => (
            ...
            >
              ...
              <div className="px-3 pb-3 pt-3.5">
                <div className="text-[12px] font-bold leading-[1.3] tracking-[-0.01em] text-navy">
                  {col.title}
                </div>
          ...
          {tab === "own" && (
            <Link
              href="/collections/new"
              className="col-span-2 flex h-[100px] flex-col items-center justify-center gap-1.5 rounded-2xl border-[1.5px] border-dashed border-[color:var(--line-strong)] text-[color:var(--muted)]"
            >
              <Plus size={22} />
