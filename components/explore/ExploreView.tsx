...
export function ExploreView({
  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-cream">
      ...
      <header className="sticky top-0 z-20 border-b border-[color:var(--line)] bg-[rgba(255,249,242,0.9)] pb-3 pt-[calc(1rem+env(safe-area-inset-top))] backdrop-blur lg:pt-6">
