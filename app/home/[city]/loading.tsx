...
export default function HomeLoading() {
  return (
    <div className="min-h-dvh bg-[color:var(--cream-2)] lg:pl-[76px]">
      <div className="mx-auto w-full max-w-[500px] px-4 pt-safe-top lg:max-w-[1180px] lg:px-8 lg:pt-8">
        <div className="h-9 w-28 animate-pulse rounded-lg bg-[color:var(--line)]" />
        <div className="mt-6 h-[196px] animate-pulse rounded-[20px] bg-[color:var(--line)] lg:h-[300px]" />
