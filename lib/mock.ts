...
export const COLLECTIONS: Collection[] = [
  ...
  {
    id: "london-harry-potter",
    title: "런던 해리 포터 성지",
    subtitle: "다이애건 앨리·9와 4분의 3 승강장 외 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #17233C 0%, #FFC857 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "london-kings-cross-platform-nine-three-quarters",
      "london-leadenhall-market-diagon-alley",
      "london-harry-potter-leaky-cauldron-bulls-head-passage",
      "london-australia-house-gringotts-bank",
      "london-great-scotland-yard-ministry-of-magic-harry-potter-5f9c",
      "london-claremont-square-grimmauld-place-harry-potter-8b41",
      "london-lambeth-bridge-harry-potter-a13d",
      "london-piccadilly-circus-harry-potter-d07e",
      "london-zoo-reptile-house-harry-potter-6e2f",
      "london-harrow-school-fourth-form-room",
    ],
  },
  {
    id: "london-romance",
    title: "런던 로맨스 영화 산책",
    subtitle: "노팅힐·러브 액츄얼리·브리짓 존스 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #FF7A85 0%, #E24352 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "london-blue-door-notting-hill-7f2a",
      "london-portobello-road-market-notting-hill-b6e1",
      "london-travel-bookshop-notting-hill-3d9c",
      "london-rosmead-garden-notting-hill-4a7d",
      "london-love-actually-somerset-house-rink-9c1d",
      "london-love-actually-oxo-tower-mark-flat-4e8a",
      "london-love-actually-grosvenor-chapel-wedding-2a7f",
      "london-love-actually-pink-house-st-lukes-mews-9c4d",
      "london-royal-exchange-buildings-bridget-jones-8a2e",
      "london-borough-market-bridget-flat-bridget-jones-9f3a",
    ],
  },
  {
    id: "newyork-home-alone",
    title: "뉴욕 나 홀로 집에 2",
    subtitle: "나 홀로 집에 2 · 공식",
    itemCount: 6,
    coverGrad: "linear-gradient(135deg, #E24352 0%, #45D6C6 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "newyork-plaza-hotel-home-alone-2-9d4a",
      "newyork-rockefeller-center-christmas-tree-home-alone-2-b7e2",
      "newyork-radio-city-music-hall-home-alone-2-e83b",
      "newyork-carnegie-hall-exterior-home-alone-2-c1f8",
      "newyork-home-alone-2-gapstow-bridge-pigeon-lady-f92c",
      "newyork-battery-park-statue-of-liberty-home-alone-2-a29c",
    ],
  },
  {
    id: "newyork-ghostbusters",
    title: "뉴욕 고스트버스터즈",
    subtitle: "고스트버스터즈 · 공식",
    itemCount: 6,
    coverGrad: "linear-gradient(135deg, #45D6C6 0%, #17233C 100%)",
    ...
    isOfficial: true,
    spots: [
      "newyork-55-central-park-west-ghostbusters-d29f",
      "newyork-ghostbusters-hook-ladder-8-fdny-e81a",
      "newyork-nypl-fifth-avenue-lions-ghostbusters-a4c1",
      "newyork-lincoln-center-plaza-ghostbusters-8e5c",
      "newyork-tavern-on-the-green-ghostbusters-c16a",
      "newyork-havemeyer-hall-columbia-ghostbusters-7b3e",
    ],
  },
  {
    id: "kyoto-anime",
    title: "교토 애니 성지 순례",
    subtitle: "타마코 마켓·케이온·유포니엄 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #45D6C6 0%, #FF7A85 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "kyoto-demachi-futaba-tamako-market-5b8f",
      "kyoto-demachibashi-tamako-market-c94d",
      "kyoto-kamogawa-delta-tamako-market-7f2b",
      "kyoto-shimogamo-jinja-tamako-market-1a6e",
      "kyoto-nanzenji-suirokaku-aqueduct-k-on-b202",
      "kyoto-kamogawa-delta-stepping-stones-k-on-a101",
      "kyoto-uji-bridge-hibike-euphonium-3c8d",
      "kyoto-keihan-uji-station-hibike-euphonium-7a2f",
      "kyoto-asagiri-bridge-hibike-euphonium-9e1b",
      "kyoto-daikichiyama-observatory-hibike-euphonium-5f4c",
    ],
  },
  {
    id: "osaka-screen",
    title: "오사카 영화·드라마 촬영지",
    subtitle: "블랙 레인·조제·한자와 나오키 외 · 공식",
    itemCount: 8,
    coverGrad: "linear-gradient(135deg, #17233C 0%, #E24352 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "osaka-black-rain-ebisubashi-d93a",
      "osaka-abenosuji-tram-black-rain-5a91",
      "osaka-juso-sakaemachi-black-rain-e03d",
      "osaka-aiaubashi-hanzawa-naoki-c89b",
      "osaka-aizenzaka-slope-josee-7a2d",
      "osaka-setoutsumi-uchikawa-steps-b47e",
      "osaka-conan-osakajo-gokurakubashi-4c2b",
      "osaka-prefectural-government-hero-e72a",
    ],
  },
  {
    id: "seoul-kdrama",
    title: "서울 K-드라마 촬영지",
    subtitle: "도깨비·이태원 클라쓰·사랑의 불시착·빈센조 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #FFC857 0%, #45D6C6 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "seoul-gamgodang-gil-stonewall-goblin-3c9d",
      "seoul-jungang-highschool-goblin-8b4e",
      "seoul-unhyeongung-yanggwan-goblin-9f2c",
      "seoul-noksapyeong-bridge-itaewon-class-241f",
      "seoul-oriole-danbam-huamdong-itaewon-class-9d4a",
      "seoul-baekbeom-square-itaewon-class-1e6b",
      "seoul-buam7-crash-landing-c48d",
      "seoul-wolfgangs-steakhouse-crash-landing-3b91",
      "seoul-vincenzo-seewon-plaza-geumga-5c8f",
      "seoul-grandpa-factory-vincenzo-e58d",
    ],
  },
  {
    id: "london-spy",
    title: "런던 스파이 영화",
    subtitle: "007 스카이폴·킹스맨 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #17233C 0%, #45D6C6 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "london-mi6-sis-vauxhall-cross-skyfall-a1f3",
      "london-national-gallery-room34-skyfall-7c2b",
      "london-charing-cross-station-skyfall-91de",
      "london-westminster-station-skyfall-e29a",
      "london-55-whitehall-rooftop-skyfall-5c6f",
      "london-old-royal-naval-college-skyfall-d048",
      "london-kingsman-savile-row-huntsman",
      "london-kingsman-lock-and-co-hatters",
      "london-kingsman-black-prince-pub",
      "london-kingsman-stanhope-mews-south",
    ],
  },
  {
    id: "newyork-devil-prada",
    title: "뉴욕 악마는 프라다를 입는다",
    subtitle: "악마는 프라다를 입는다 · 공식",
    itemCount: 6,
    coverGrad: "linear-gradient(135deg, #17233C 0%, #FF7A85 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "newyork-elias-clarke-hq-devil-prada-e91a",
      "newyork-miranda-townhouse-devil-prada-d05b",
      "newyork-st-regis-king-cole-bar-devil-prada-4e6a",
      "newyork-smith-wollensky-devil-prada-b3d8",
      "newyork-natural-history-museum-devil-prada-7c4f",
      "newyork-bubbys-tribeca-devil-prada-2f9c",
    ],
  },
  {
    id: "seoul-film",
    title: "서울 영화 촬영지",
    subtitle: "기생충·괴물·어벤져스·패스트 라이브즈 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #E24352 0%, #17233C 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "seoul-jahamun-tunnel-stairs-parasite-8f3a",
      "seoul-huamdong-dodak-bridge-parasite-e29d",
      "seoul-seongbukdong-seonjamro-parasite-3c8b",
      "seoul-doejissal-super-parasite-2b7c",
      "seoul-banpo-hangang-park-the-host-c9d4",
      "seoul-nodeul-island-the-host-f2a8",
      "seoul-avengers-some-sevit-banpo-e5f6",
      "seoul-mapo-bridge-avengers-age-of-ultron-7f3a",
      "seoul-bondong-stairs-past-lives-c81a",
      "seoul-namsan-cablecar-past-lives-4f9b",
    ],
  },
  {
    id: "rome-cinema",
    title: "로마 영화 산책",
    subtitle: "로마의 휴일·달콤한 인생·천사와 악마 · 공식",
    itemCount: 8,
    coverGrad: "linear-gradient(135deg, #FFC857 0%, #E24352 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "rome-bocca-verita-roman-holiday-9c3e",
      "rome-spanish-steps-roman-holiday-gelato-e91a",
      "rome-via-margutta-roman-holiday-6f1c",
      "rome-castel-santangelo-river-roman-holiday-f7b2",
      "rome-pantheon-rocca-cafe-roman-holiday-c81f",
      "rome-trevi-fountain-la-dolce-vita-midnight-b47c",
      "rome-piazza-del-popolo-la-dolce-vita-4f9a",
      "rome-piazza-navona-quattro-fiumi-angels-demons-4c8e",
    ],
  },
  {
    id: "tokyo-film",
    title: "도쿄 영화 촬영지",
    subtitle: "로스트 인 번역·퍼펙트 데이즈·울버린·어느 가족 · 공식",
    itemCount: 10,
    coverGrad: "linear-gradient(135deg, #FF7A85 0%, #17233C 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "tokyo-joganji-temple-lost-in-translation-9b2c",
      "tokyo-kabukicho-yasukunidori-lost-in-translation-7f4c",
      "tokyo-shabuzen-shibuya-lost-in-translation-b93d",
      "tokyo-zojoji-daiden-tokyo-tower-wolverine-4a8f",
      "tokyo-ueno-jewelrybridge-wolverine-a02c",
      "tokyo-manseibashi-wolverine-3d8f",
      "tokyo-yoyogi-fukamachi-perfect-days-7e3a",
      "tokyo-ebisu-park-toilet-perfect-days-4b6c",
      "tokyo-arakawa-8chome-danchi-shoplifters-a93c",
      "tokyo-joyful-minowa-fujiya-shoplifters-9c4a",
    ],
  },
  {
    id: "taipei-cinema",
    title: "타이베이 영화 산책",
    subtitle: "턴 레프트 턴 라이트·몽가·사랑만세 · 공식",
    itemCount: 9,
    coverGrad: "linear-gradient(135deg, #45D6C6 0%, #FFC857 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "taipei-ximending-turn-left-turn-right-e04f",
      "taipei-beitou-station-turn-left-turn-right-7f2a",
      "taipei-turn-left-turn-right-beitou-park-fountain-7d31",
      "taipei-fujin-street-turn-left-turn-right-b91d",
      "taipei-huaxi-night-market-monga-e93f",
      "taipei-monga-bopiliao-lane173-01",
      "taipei-qingshan-temple-monga-f4a9",
      "taipei-vivelamour-daan-amphitheater-02",
      "taipei-linyi-street-vive-l-amour-a5f9",
    ],
  },
  {
    id: "bangkok-cinema",
    title: "방콕 영화 촬영지",
    subtitle: "행오버 2·007·화양연화 · 공식",
    itemCount: 8,
    coverGrad: "linear-gradient(135deg, #FFC857 0%, #17233C 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "bangkok-lebua-skybar-hangover-2-7b1c",
      "bangkok-plaengnam-chinatown-hangover-2-4b7d",
      "bangkok-soicowboy-siamsams-hangover-2-c815",
      "bangkok-sukhumvit71-nana-hangover-2-a63e",
      "bangkok-mandarin-oriental-golden-gun-7b2e",
      "bangkok-wat-suthat-giant-swing-golden-gun-1d6c",
      "bangkok-democracy-monument-golden-gun-c83a",
      "bangkok-old-customs-house-in-the-mood-for-love",
    ],
  },
  {
    id: "barcelona-cinema",
    title: "바르셀로나 영화 촬영지",
    subtitle: "비키 크리스티나 바르셀로나·언차티드·향수 · 공식",
    itemCount: 9,
    coverGrad: "linear-gradient(135deg, #E24352 0%, #FFC857 100%)",
    isOwn: false,
    isOfficial: true,
    spots: [
      "barcelona-park-guell-dragon-stairway-vicky-cristina-7f2a",
      "barcelona-casa-mila-rooftop-vicky-cristina-3d9c",
      "barcelona-ciutadella-cascada-vicky-cristina-b48f",
      "barcelona-tibidabo-skywalk-vicky-cristina-1e6b",
      "barcelona-uncharted-santa-maria-del-pi-9a1b",
      "barcelona-uncharted-placa-reial-b91d",
      "barcelona-uncharted-born-centre-a24c",
      "barcelona-laberint-dhorta-perfume-richis-maze-3b9e",
      "barcelona-placa-sant-felip-neri-perfume-plum-girl-8d3f",
    ],
  },
  {
    id: "my-seoul",
